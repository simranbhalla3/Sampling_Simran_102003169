...
sampler2 = NearMiss()
sampler3 = ADASYN()
sampler4 = RandomOverSampler(sampling_strategy='minority', random_state=12)
sampler5 = SMOTE()

model1 = KNeighborsClassifier(n_neighbors=5)
model2 = RandomForestClassifier(n_estimators=100, random_state=42)
model3 = ExtraTreesClassifier(n_estimators=100, random_state=42)
model4 = svm.SVC(kernel='sigmoid')
model5 = LogisticRegression(random_state=42,max_iter=500)
